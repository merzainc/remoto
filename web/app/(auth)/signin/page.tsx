...
export default function SignInPage() {
  return (
    <main className='relative flex flex-1 flex-col overflow-hidden px-4 py-8 sm:px-6 lg:px-8'>
      <div className='absolute inset-0 text-zinc-900/[0.07] [mask-image:linear-gradient(to_bottom_left,white,transparent,transparent)]'>
      ...
      <div className='relative flex flex-1 flex-col items-center justify-center pb-16 pt-12'>
        ...
        <h1 className='sr-only'>Log in to your Remoto account</h1>
        <form action='/login' className='w-full max-w-sm'>
          <Fieldset>
            <FieldGroup className='space-y-6'>
              <Field>
                <Label>Email address</Label>
                <Input type='email' placeholder='someone@org.com' required />
              </Field>
              <Field>
      ...
      <footer className='relative shrink-0'>
        <div className='space-y-4 text-sm text-gray-900 sm:flex sm:items-center sm:justify-center sm:space-x-4 sm:space-y-0'>
          ...
          <Link
            className='inline-flex justify-center rounded-lg text-sm font-semibold py-2.5 px-4 text-zinc-900 ring-1 ring-zinc-900/10 hover:ring-zinc-900/20'
            href='/sign-up'
          >
            <span>
