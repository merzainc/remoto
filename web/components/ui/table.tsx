    ...
    >
      <div className='flow-root'>
        <div
          ...
          className={clsx(
            className,
            'sm:-mx-6 lg:-mx-8 -mx-4 -my-2 border border-zinc-950/10 bg-white sm:rounded-lg shadow overflow-x-auto whitespace-nowrap'
          )}
        >
...
export function TableHead({ className, ...props }: React.ComponentPropsWithoutRef<'thead'>) {
  return <thead className={clsx(className, 'text-zinc-900 bg-gray-50')} {...props} />;
}
...
export function TableHeader({ className, ...props }: React.ComponentPropsWithoutRef<'th'>) {
  ...
  return (
    <th
      ...
      className={clsx(
        className,
        'border-b border-b-zinc-950/10 text-zinc-900  px-4 py-2 font-semibold first:pl-[var(--gutter,theme(spacing.2))] last:pr-[var(--gutter,theme(spacing.2))] dark:border-b-white/10',
  ...
  return (
    <td
      ...
      className={clsx(
        ...
        !striped && 'border-b border-zinc-200 dark:border-white/5',
        grid && 'border-l border-l-zinc-950/5 first:border-l-0 dark:border-l-white/5',
        dense ? 'py-2.5' : 'py-4',
        !bleed && 'sm:first:pl-2 sm:last:pr-2'
      )}
