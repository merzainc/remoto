...
export const Checkbox = forwardRef(function Checkbox(
  ...
  return (
    <div
      className={mergeClasses('flex items-center gap-2 relative', className)}
    >
      {checked && (
      ...
      <input
        ...
        className={mergeClasses(
          ...
          !disabled &&
            'dark:focus:ring-palette-blue8 dark:hocus:border-palette-blue8',
