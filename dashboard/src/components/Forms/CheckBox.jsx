...
const base = [
  ...
  'group-data-[disabled]:border-zinc-950/25 group-data-[disabled]:bg-zinc-950/5 group-data-[disabled]:[--checkbox-check:theme(colors.slate.950/50%)] group-data-[disabled]:before:bg-transparent',
...
const colors = {
  'dark/zinc': [
    '[--checkbox-check:theme(colors.white)] [--checkbox-checked-bg:theme(colors.slate.900)] [--checkbox-checked-border:theme(colors.slate.950/90%)]',
    'dark:[--checkbox-checked-bg:theme(colors.slate.600)]',
  ],
  'dark/white': [
    '[--checkbox-check:theme(colors.white)] [--checkbox-checked-bg:theme(colors.slate.900)] [--checkbox-checked-border:theme(colors.slate.950/90%)]',
    'dark:[--checkbox-check:theme(colors.slate.900)] dark:[--checkbox-checked-bg:theme(colors.white)] dark:[--checkbox-checked-border:theme(colors.slate.950/15%)]',
  ],
  white:
  ...
  zinc: '[--checkbox-check:theme(colors.white)] [--checkbox-checked-bg:theme(colors.slate.600)] [--checkbox-checked-border:theme(colors.slate.700/90%)]',
...
export function Checkbox({ color = 'dark/zinc', className, ...props }) {
  return (
    <HeadlessCheckbox
      ...
      {...props}
    >
      <span className={mergeClasses([base, colors[color]])}>
        <svg
